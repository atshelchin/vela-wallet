// Ported from src/models/chains.ts @ c13e89d4 (spec 025). Chain brand colours
// are CONTENT (the audit whitelists this file for the same reason it exempts
// fixtures): a design token cannot name another chain's brand.
/**
...
export const CHAINS: ChainMeta[] = [
	...
	},
	{
		...
		chainId: 480,
		apiNetworkId: 'worldchain-mainnet',
		nativeSymbol: 'ETH',
		iconLabel: 'WLD',
		iconColor: '#000000',
		iconBg: '#ECECEC',
