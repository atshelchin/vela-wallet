// Ported from src/services/wallet-state-core/balance-resident.ts @ c13e89d4 (spec 025).
/**
...
import { toApiToken } from './balance-executor';
import { createBalanceSession } from './balance-session';
...
export const INITIAL_VIEW: BalanceView = {
	address: null,
