...
//!
//! 1412 paths = 1333 leaf + 79 branch. Repeated per locale these key bytes
//! would cost 559860 bytes; interned once they cost 38768.
...
pub(crate) static PATHS: [&str; 1412] = [
    "about",
    "about.footer",
    "about.linkGitHub",
    ...
    "onboarding.login.signInSecurityKeyBtn",
...
pub(crate) static IS_BRANCH: [u8; 177] = [
    ...
    0x00, 0x00, 0x00, 0x02, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x27, 0x49,
    0x12, 0x02, 0x40, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x04, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x53, 0x80, 0x20, 0x04,
    0x48, 0x08, 0x10, 0x04, 0x18, 0x02, 0x00, 0x40, 0x00, 0x44, 0x00, 0x02, 0x08, 0x04, 0x10, 0x04,
    0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1412;
