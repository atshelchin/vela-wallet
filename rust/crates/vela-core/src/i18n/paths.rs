...
//!
//! 1410 paths = 1331 leaf + 79 branch. Repeated per locale these key bytes
//! would cost 558840 bytes; interned once they cost 38700.
...
pub(crate) static PATHS: [&str; 1410] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 177] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x40, 0x00, 0x08, 0x00, 0xc0, 0x49, 0x92,
    0x84, 0x00, 0x10, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x14, 0x20, 0x08, 0x01,
    0x12, 0x02, 0x04, 0x01, 0x86, 0x00, 0x00, 0x10, 0x00, 0x11, 0x80, 0x00, 0x02, 0x01, 0x04, 0x01,
    0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1410;
