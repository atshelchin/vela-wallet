...
//!
//! 1419 paths = 1340 leaf + 79 branch. Repeated per locale these key bytes
//! would cost 563340 bytes; interned once they cost 39000.
...
pub(crate) static PATHS: [&str; 1419] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 178] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x40, 0x00, 0x08, 0x00, 0x80, 0x93,
    0x24, 0x09, 0x01, 0x20, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x08, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x29, 0x40, 0x10,
    0x02, 0x24, 0x04, 0x08, 0x02, 0x0c, 0x01, 0x00, 0x20, 0x00, 0x22, 0x00, 0x01, 0x04, 0x02, 0x08,
    0x02, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1419;
