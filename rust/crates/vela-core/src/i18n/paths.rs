...
//!
//! 1429 paths = 1349 leaf + 80 branch. Repeated per locale these key bytes
//! would cost 566820 bytes; interned once they cost 39248.
...
pub(crate) static PATHS: [&str; 1429] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 179] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x00, 0x01, 0x20, 0x00, 0x00,
    0x4e, 0x92, 0x24, 0x04, 0x80, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x20, 0x00, 0x20, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa6, 0x00,
    0x41, 0x08, 0x90, 0x10, 0x20, 0x08, 0x30, 0x04, 0x00, 0x80, 0x00, 0x88, 0x00, 0x04, 0x10, 0x08,
    0x20, 0x08, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1429;
