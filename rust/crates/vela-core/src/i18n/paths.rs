...
//!
//! 1462 paths = 1382 leaf + 80 branch. Repeated per locale these key bytes
//! would cost 577995 bytes; interned once they cost 39993.
...
pub(crate) static PATHS: [&str; 1462] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 183] = [
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0x00, 0x02, 0x40, 0x00,
    ...
    0x00, 0x00, 0x4c, 0x01, 0x82, 0x10, 0x20, 0x21, 0x40, 0x10, 0x60, 0x08, 0x00, 0x00, 0x01, 0x10,
    0x01, 0x08, 0x20, 0x10, 0x40, 0x10, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1462;
