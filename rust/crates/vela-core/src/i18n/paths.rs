...
//!
//! 1390 paths = 1311 leaf + 79 branch. Repeated per locale these key bytes
//! would cost 549855 bytes; interned once they cost 38101.
...
pub(crate) static PATHS: [&str; 1390] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 174] = [
    ...
    0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x04, 0x80, 0x00, 0x00, 0x9c, 0x24, 0x49, 0x08, 0x00,
    0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x40, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4c, 0x01, 0x82, 0x10, 0x20, 0x21, 0x40,
    0x10, 0x60, 0x08, 0x00, 0x00, 0x01, 0x10, 0x01, 0x08, 0x20, 0x10, 0x40, 0x10, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1390;
