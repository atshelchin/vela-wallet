...
//!
//! 1325 paths = 1246 leaf + 79 branch. Repeated per locale these key bytes
//! would cost 521430 bytes; interned once they cost 36206.
...
pub(crate) static PATHS: [&str; 1325] = [
    "about",
    "about.footer",
    "about.linkGitHub",
...
pub(crate) static IS_BRANCH: [u8; 166] = [
    ...
    0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0xa6, 0x00, 0x41, 0x08, 0x90, 0x10, 0x20, 0x08, 0x30, 0x04, 0x00, 0x80, 0x00, 0x88, 0x00,
    0x04, 0x10, 0x08, 0x20, 0x08, 0x00,
];

/// Number of entries in [`PATHS`]. Value tables carry `N_PATHS + 1` offsets.
pub(crate) const N_PATHS: usize = 1325;
